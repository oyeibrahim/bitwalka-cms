<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Referral ID -->
        <div class="mt-4">
            <x-input-label for="referral_id" :value="__('Referral ID')" />
            <x-text-input id="referral_id" class="block mt-1 w-full" type="text" name="referral_id" :value="($ref !== null)? $ref : old('referral_id')" autofocus autocomplete="referral_id" />
