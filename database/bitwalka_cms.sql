...
--
-- Database: `bitwalka_cms`
--
CREATE DATABASE IF NOT EXISTS `bitwalka_cms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bitwalka_cms`;
...
CREATE TABLE `users` (
  ...
  `remember_token` varchar(300) DEFAULT NULL COMMENT 'Laravel remeber me feature',
  `email_auth` varchar(100) DEFAULT NULL,
  `google_auth` varchar(100) DEFAULT NULL,
  `referral_id` varchar(100) DEFAULT NULL,
  `locale` varchar(10) NOT NULL DEFAULT 'en' COMMENT 'Site language e.g en, ar',
  ...
  `theme` varchar(50) NOT NULL DEFAULT 'LIGHT' COMMENT 'site theme mode LIGHT / DARK',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '"0=Deactivated account, 1=Activated account, 2=Pending account, 3=Suspended account"',
  `verified` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0= did not submit info, 1= verified, 2=Cancel, 3=processing',
  `ip` varchar(50) DEFAULT NULL,
  `last_login` datetime DEFAULT NULL COMMENT 'Added from the app, may be in different timezone. Check',
  `last_logout` datetime DEFAULT NULL COMMENT 'Added from the app, may be in different timezone. Check',
